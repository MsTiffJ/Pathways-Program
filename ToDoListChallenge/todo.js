function enterToDo() {
    ...
    var brandNewChore = document.forms["myChoreBox"]["newChore"].value; /* Capturing and storing the value from the form entry for the chore */
    var brandNewDate = document.forms["myChoreBox"]["newDueDate"].value; /*Capturing and storing the value from the form entry for the date*/
    var tableRef;
    /*Verify */
...
function clearTask() {
    do { /* do while loop to make sure user enter a task number to clear a single task */
        var taskChoice = prompt("Please choose a task number to clear"); /*Capturing the number */
    } while (taskChoice == "");
    var tableRef; /* variable used to store table ID  */
    tableRef = document.getElementById("myTaskList"); /* Getting the ID of the table storing the value in the variable  */
    ...
    for (var i = 0; i < tableRef.rows.length; i++) { /* For loop to restructure the list after deleting a task  */
        ...
        var newTaskName = str.substring(str.indexOf(".")); /* Remove the number in front of the period  */
        var finalTaskName = (tableRef.rows[i].rowIndex + 1) + newTaskName; /* Add the number in front of period in order to restructure the list  */
...
function updateTask() {
    ...
    do { /* do while loop to make sure user enter a task number to update  */
        var taskUpdate = prompt("Please choose a task number to update"); /* variable used to store task number  */
    } while (taskUpdate == "");
    do { /* do while loop to make sure user enter a task name to update  */
        var newTaskUpdate = prompt("Please enter the new task name"); /* variable used to store task name  */
    } while (newTaskUpdate == "");
    do { /* do while loop to make sure user enter a date to update */
        var newDateUpdate = prompt("Please enter the date of the new task (yyyy-mm-dd)"); /* variable used to task date  */
    } while (newDateUpdate == "");
...
function completeTask() {
    ...
    tableRef = document.getElementById("myTaskList"); /* Getting the ID of the table storing the value in the variable  */
    do {
        var taskUpdate = prompt("Please choose a task number to complete"); /* variable used to store task number  */
    } while (taskUpdate == "");
