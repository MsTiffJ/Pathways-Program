async function getMeat() {
    ...
    let brandNewType: string = (<HTMLInputElement>document.getElementById("newType")).value;
    let brandNewParagraphs: string= (<HTMLInputElement>document.getElementById("newParagraphs")).value;
    let brandNewSentences: string= (<HTMLInputElement>document.getElementById("newSentences")).value;
